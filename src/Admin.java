...
class Admin extends User {
  ...
  public void runTask(String menu, ArrayList users, ArrayList courses) {
    ...
    if (menu.equals("List Courses")) {
    ...
    } else if (menu.equals("Assign Course")) { //this assign course only applied to lecturer, may need to add function for registering student too
      Scanner scn = new Scanner(System.in);
      ...
      System.out.print("Session (e.g., 2005/2006): ");
